  ...
  return (
    <div>
      ...
      <main className="min-h-screen bg-cyan dark:bg-purple flex flex-col items-center justify-center p-8">
        {/* Título */}
        <h1 className="text-5xl font-bold text-white mb-10">Referências</h1>
        ...
        <div className="w-full max-w-3xl min-h-[400px] bg-white rounded-2xl shadow-lg p-8">
          ...
          {/* Aqui você pode colocar seus links */}
          <ul className="space-y-3 text-blue-600">
            ...
            <li>
              <a href="https://www.figma.com/exit?url=http%3A%2F%2Fmilanesa.ime.usp.br%2Frbie%2Findex.php%2Frbie%2Farticle%2Fview%2F7140" target="_blank" rel="noopener noreferrer">
